...
```yaml
name:       "BiBi"
role:       ["Student", "Freelancer", "Full-Stack Dev", "Eternal Learner"]
location:   "🌍 Somewhere with Wi-Fi"
status:     "Building cool things to get into a good college"
philosophy: "Work smarter, not harder — automate everything else"
fun_fact:   "Lazy + Smart = Efficient 😎"
open_to:    ["Freelance projects", "Collabs", "Internships", "Cool ideas"]
```
...
<details>
<summary><b>☁️ Cloud, Infra & Tools</b></summary>
<br/>
...
> — Every lazy-smart developer ever
...
*⚡ Available for freelance · Open to opportunities · Always building*
